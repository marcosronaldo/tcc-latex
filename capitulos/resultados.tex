...
%TODO falar q a relativização não é necessária devido a independencia das métricas utilizadas em relação ao tamanho. Então comparação direta pode ser útil.
...